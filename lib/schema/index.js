...
export { CURRENT_SCHEMA_VERSION, MIN_SUPPORTED_SCHEMA_VERSION, UnsupportedSchemaError, isCurrent, isSupported, needsMigration, isTooNew, canImport, describeVersion, } from './versions.js';
/* —— 分区表（第三方实现 importer/exporter 的路径权威） —— */
export { SECTION_IDS, SECTION_JSON_PATHS, SECTION_FILE_PREFIXES, isFileSection, } from './config.js';
