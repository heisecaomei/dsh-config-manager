 ...
 */
export { CURRENT_SCHEMA_VERSION, MIN_SUPPORTED_SCHEMA_VERSION, UnsupportedSchemaError, isCurrent, isSupported, needsMigration, isTooNew, canImport, describeVersion, } from './versions.ts';
export { SECTION_IDS, SECTION_JSON_PATHS, SECTION_FILE_PREFIXES, isFileSection, } from './config.ts';
export type { Platform, SectionId, EncryptionInfo, Manifest, NamespaceRecord, SettingsSection, UiMigrationNote, UiSection, ProviderEntry, ProvidersSection, PluginEntry, PatchLine, LocalPluginTarball, PluginsSection, McpServerEntry, McpSection, PromptEntry, PromptsSection, WorkspaceRecord, WorkspacesSection, CredentialStatus, CredentialsSection, FileEntry, FilesSection, SectionData, } from './types.ts';
