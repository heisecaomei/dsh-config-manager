 ...
 * 从 pnpm 的真实诊断文本里认。
 */
export type DshPluginFailureCode = 'hoist-pattern-diff' | 'adding-to-root' | 'not-a-workspace' | 'release-age-violation' | 'git-build-blocked' | 'fetch-404' | 'transient-network' | 'pnpm-missing' | 'patch-file-missing';
