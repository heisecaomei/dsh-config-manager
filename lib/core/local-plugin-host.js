...
import { packLocalPlugins, parsePackOutput } from './local-plugin-pack.js';
import { quoteCmdArg } from './plugin-cli.js';
 ...
 * 避免 tarball 残留在用户磁盘上。
 */
export function createLocalPluginPackHook(opts) {
...
//# sourceMappingURL=local-plugin-host.js.map